...
myBrowser1 :: String
myBrowser1 = "brave"        -- Sets brave as my second browser

-- myWebApp :: String
-- myWebApp =  "/usr/lib/brave-bin/brave --profile-directory=Default --app-id=pjibgclleladliembfgfagdaldikeohf"

myVisualStudioCode :: String
myVisualStudioCode = "code"  -- sets visual studio as my first code editor

mySublimeText :: String
mySublimeText = "subl"      -- sets sublime text as my second code editor

myTelegramDesktop :: String
myTelegramDesktop = "telegram-desktop"

myHotKey :: String
myHotKey = "rofi -show drun -show-icons -display-drun Search "
...
myFileManager1 :: String
myFileManager1 = "vifm"


myYoutube :: String
myYoutube = "/opt/Youtube/./Youtube"

myYoutubeMusic :: String
myYoutubeMusic = "youtube-music"
...
myStartupHook = do
  ...
  spawnOnce "xinput set-prop 'PixArt Dell MS116 USB Optical Mouse' 'libinput Natural Scrolling Enabled' 1"
  spawnOnce "dunst"
  ...
  -- spawnOnce "xargs xwallpaper --stretch < ~/.cache/wall-01"
...
myManageHook = composeAll
  ...
  , className =? "Pulsar"            --> doShift ( myWorkspaces !! 0 )
  , className =? "TelegramDesktop" --> doShift ( myWorkspaces !! 5 )
  , className =? "discord"         --> doShift ( myWorkspaces !! 5 )
  , className =? "Youtube"         --> doShift ( myWorkspaces !! 7 )
...
myKeys c =
  ...
  , ("M-p r", addName "View manpages"          $ spawn "dm-man")
  ...
  , ("M-p m", addName "Listen to online radio" $ spawn "alacritty -e bash $HOME/automation-linux")
  , ("M-p s", addName "Search various engines" $ spawn "dm-websearch")
  , ("M-p t", addName "Translate text"         $ spawn "dm-translate")]

  ^++^ subKeys "Favorite programs"
  [ ("M-<Return>", addName "Launch terminal"    $ spawn (myTerminal))
  , ("M1-<Return>", addName "Launch kitty"    $ spawn (myTerminal1))
  , ("M-b", addName "Launch qute browser"       $ spawn (myBrowser))
  , ("M-n b", addName "Launch brave browser"  $ spawn (myBrowser1))
  -- , ("M-n s", addName "Launch Spotify Web player"  $ spawn (myWebApp))
  , ("M-n c", addName "Launch V.S Code"         $ spawn (myVisualStudioCode))
  , ("M-n s", addName "Launch Sublime Text"     $ spawn (mySublimeText))
  , ("M-n a", addName "Launch Pulsar Code Editor"     $ spawn (myPulsar))
  , ("M-n t", addName "Launch Telegram Desktop" $ spawn (myTelegramDesktop))
  , ("M-n d", addName "Launch Discord"          $ spawn (myDiscord))
  , ("M-n h", addName "Launch MyHotKey"         $ spawn (myHotKey))
  , ("M-n f", addName "Launch Pcmanfm File Manager"          $ spawn (myFileManager))
  , ("M-n y", addName "Launch Youtube"          $ spawn (myYoutube))
  , ("M-n m", addName "Launch YoutubeMusic"     $ spawn (myYoutubeMusic))
  , ("M-n p", addName "Launch Spotify"          $ spawn (mySpotify))
  , ("M-M1-h", addName "Launch htop"            $ spawn (myTerminal ++ " -e htop"))
  , ("M-n n", addName "Launch Neovim"           $ spawn (myTerminal ++ " -e nvim"))
  , ("M-n v", addName "Launch Vifm"             $ spawn (myTerminal ++ " -e vifm"))]
  ...
  , ("<XF86MonBrightnessUp>", addName "brightness up"$ spawn "brightnessctl set +10%")
  , ("<XF86MonBrightnessDown>", addName "brightness down"$ spawn "brightnessctl set 10%-")
