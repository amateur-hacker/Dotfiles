...
# Import from garuda
alias upd='/usr/bin/garuda-update'              # To update Garuda Linux
...
### For My Coding Directory 
alias codedir="cd /home/amateur_hacker/Documents/My-Documents/Coding\ folder/"

### RANDOM COLOR SCRIPT ###
# Get this script from my GitLab: gitlab.com/dwt1/shell-color-scripts
# Or install it from the Arch User Repository: shell-color-scripts
#colorscript random
fm6000 -m 8 -g 12 -w 20 -random -c green
